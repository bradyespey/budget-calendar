                    ...
                    <tr
                      ...
                      <td className="p-4">
                        <span 
                          ...
                          onClick={() => handleFilterClick('frequency', transaction.frequency)}
                      ...
                      <td className="p-4">
                        <span 
                          className="cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-600 px-2 py-1 rounded transition-colors"
                          onClick={() => handleFilterClick('account', transaction.account)}
                       ...
                       <td className="p-4 text-gray-600 dark:text-gray-400">
                         <span 
                           className="cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-600 px-2 py-1 rounded transition-colors"
                           onClick={() => handleFilterClick('category', transaction.category)}
                      ...
                      <td className="p-4">
                        <span 
                          ...
                          onClick={() => handleFilterClick('source', transaction.source)}
