...
export function LoginPage() {
  ...
  // Redirect to the dashboard or previous location if already authenticated
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-4">
      <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-xl shadow-md p-8 border border-gray-200 dark:border-gray-700">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">Sign in to access your budget calendar</p>
        </div>
